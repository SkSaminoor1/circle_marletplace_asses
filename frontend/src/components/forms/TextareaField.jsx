export default function TextareaField({ field, value, onChange, error }) {
  const { id, label, key, placeholder, help_text, required } = field;
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <textarea
        ...
        className={`w-full rounded-lg border px-3.5 py-2 text-sm text-gray-900 shadow-sm focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 placeholder:text-gray-400 resize-y min-h-[80px] ${
